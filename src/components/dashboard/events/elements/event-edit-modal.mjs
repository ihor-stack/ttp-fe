 ...
 */
export function createEventEditModalComponent({
  createComponent,
  html,
  renderer,
  withEventBus,
  ...
  createComponent(
    ...
    withEventBus(eventBus, {
      ...
      closeModal(event) {
        ...
        eventBus.publish('ttp-event-edit-modal', {
      ...
      onSubmit(event) {
        event.preventDefault();
        if (this.state.isEditable && this.state.isEventChanged) {
          const event = this.getEvent();
          //save form
                  ...
                  <div class="plan-event-container">
                    ...
                    <div class="plan-event-form-container">
                      <form class="plan-event-form" @submit=${this.onSubmit}>
                        <div
                          class="inputs-group ${
                            this.state.isEditable ? '' : 'inputs-group--no-edit'
                          }"
                        >
                          <ttp-input
                            name="eventTitle"
                        ...
                        <div class="inputs-group inputs-group--row-room inputs-group--no-edit">
                          <ttp-input
                            name="roomTitle"
                            label="Room Title"
                        ...
                        <div
                          class="inputs-group inputs-group--no-edit"
                        >
                          <ttp-input
                            name="eventTimeZone"
                            label="Time Zone"
                        ...
                        <div class="form-button-group">
                          ...
                          type="submit"
                          class="btn-edit ${
                            this.state.isEditable && !this.state.isEventChanged
                              ? 'btn-edit--no-changed'
                              : ''
                          }"
                            ${
                              this.state.isEditable &&
                              !this.state.isEventChanged &&
                              'disabled'
                            }
                          >
                            ${
