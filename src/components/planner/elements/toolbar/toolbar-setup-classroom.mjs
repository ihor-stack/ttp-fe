 ...
 */
export function createToolbarSetupClassroomComponent({
  createComponent,
  html,
  renderer,
  withEventBus,
  ...
  createComponent(
    ...
    withEventBus(eventBus, {
      ...
      onShowTables() {
        this.onResetDuplicate();
        this.setState(state => {
          return { ...state, toolbarLevel: 2, isTables: true };
        });
      },
          ...
          <ul class="toolbar-content">
            ${isParent
              ? html` <li class="toolbar-item toolbar-item--horizontal">
                    <div class="toolbar-item__label">Tables</div>
                    <div class="duplicate-icon" @click=${this.onShowTables}>
                      <svg
                        width="8"
                        height="14"
                        viewBox="0 0 8 14"
            ...
            ${!isParent && this.state.isTables
              ? html`<li class="toolbar-item">
                  ...
                  <li class="toolbar-item">
                    <ttp-input
                      name="${this.props.assetId}_tables_${this.props
                        .assetType}"
                      input-id="${this.props.assetId}_tables_${this.props
                        .assetType}"
                      maxlength="4"
                      input-style="toolbar-setup"
                      value=${this.getComputedSetup.tables_total}
                    ></ttp-input>
                    <span class="toolbar-item__label">Tables</span>
                  </li>
                  <li class="toolbar-item">
                    <div class="toolbar-item__icon-input">
                      ...
                      <ttp-input
                        name="${this.props.assetId}_tableSpacing_${this.props
                          .assetType}"
                        input-id="${this.props.assetId}_tableSpacing_${this
                          .props.assetType}"
                        maxlength="4"
                        input-style="toolbar-setup"
                        post-fix="IN"
                        value=${this.getComputedSetup.table_spacing_inch}
                      ></ttp-input>
                    </div>
                    <span class="toolbar-item__label">Table Spacing</span>
                  </li>
                  <li class="toolbar-item">
                    <ttp-input
                      name="${this.props.assetId}_tablesPerRow_${this.props
                        .assetType}"
                      input-id="${this.props.assetId}_tablesPerRow_${this.props
                        .assetType}"
                      maxlength="4"
                      input-style="toolbar-setup"
                      value=${this.getComputedSetup.tables_per_row}
                    ></ttp-input>
                    <span class="toolbar-item__label">Tables per row</span>
                  </li>`
              : ''}
              ...
              ? html`
                  ...
                  <li class="toolbar-item">
                    <ttp-input
                      ...
                      maxlength="4"
                      input-style="toolbar-setup"
                      value=${this.getComputedSetup.chairs_per_table}
                    ></ttp-input>
                    <span class="toolbar-item__label">Chairs per Table</span>
                  </li>
                `
              : ''}
